...
The XAI Agent uses the Gemini API to generate natural language explanations for predictions. You need to provide a `GEMINI_API_KEY` for this feature to work.
...
> You can get a free Gemini API key at [aistudio.google.com/app/apikey](https://aistudio.google.com/app/apikey).
>
> Without this key, classification and SHAP/LIME visualizations will still work — only the natural language explanation summary generated by Agent 3 will be unavailable.
...
The full IEEE-format paper is at [`reports/data_mining/211101023_OrucCakir_BIL476_report.tex`](reports/data_mining/211101023_OrucCakir_BIL476_report.tex).

PDF: [`reports/data_mining/211101023_OrucCakir_BIL476_report.pdf`](reports/data_mining/211101023_OrucCakir_BIL476_report.pdf).
